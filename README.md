...
- 💼 Software Engineer in **Accenture**
...
`LangChain` • `LangGraph` • `AI Agents` • `MCP`
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,playwright" />
</p>
...
`UI Automation` • `API Testing` • `Page Object Model`
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=linux,docker,kubernetes,gcp,git,githubactions" />
</p>

<p align="center">

`Linux` • `Networking` • `Docker` • `Docker Compose`
